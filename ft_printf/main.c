...
LONG_MIN, ULONG_MAX, 0, -42);
	...
	// i
	printf("===================================\n");
	r = ft_printf("ft i %u %i %i %i %i\n", INT_MAX, INT_MIN, LONG_MAX, 0, -42);
	r1 = printf("pt i %i %i %i %i %i\n", INT_MAX, INT_MIN, LONG_MAX, 0, -42);
	printf("ft_printf %i - printf %i\n", r, r1);	
	// u
	printf("===================================\n");
	r = ft_printf("ft u %u \n", 0);
	...
	printf("ft_printf %i - printf %i\n", r, r1);
	r = ft_printf("ft pointer %5p, %5p, %5p, %5p, %5p, %5p\n", (void *)0, (void *)0xABCDE,
	 (void *)ULONG_MAX, (void *)LONG_MIN, (void *)-1, (void *)-2352);
	r1 = printf("pt pointer %5p, %5p, %5p, %5p, %5p, %5p\n", (void *)0, (void *)0xABCDE,
	  (void *)ULONG_MAX, (void *)LONG_MIN, (void *)-1, (void *)-2352);
	printf("ft_printf %i - printf %i\n", r, r1);
	...
	printf("ft_printf %i - printf %i\n", r, r1);
	r = ft_printf("ft hex %01.x, %01.x, %01.x, %01.x, %01.x, %01.x, %01.x, %01.x, %01.x, %01.x\n", 0, 5, -1, -10, 0x1234, -1862, 0xABCDE, INT_MIN, INT_MAX, 
UINT_MAX);
	r1 = printf("pt hex %01.x, %01.x, %01.x, %01.x, %01.x, %01.x, %01.x, %01.x, %01.x, %01.x\n", 0, 5, -1, -10, 0x1234, -1862, 0xABCDE, INT_MIN, INT_MAX, 
UINT_MAX);
	printf("ft_printf %i - printf %i\n", r, r1);
	r = ft_printf("ft hex %#5.x\n", 5);
	r1 = printf("pt hex %#5.x\n", 5);
	printf("ft_printf %i - printf %i\n", r, r1);
	// X
	printf("===================================\n");
...
//	r = ft_printf(0);
//	r1 = printf(0);
//	printf("test with 0 ft_printf %i - printf %i\n", r, r1);
	// test random
	printf("================= random test ==================\n");
	r = ft_printf("ft \001\002\007\v\010\f\r\n");
	r1 = printf("pt \001\002\007\v\010\f\r\n");
	printf("ft_printf %i - printf %i\n", r, r1);
	printf("================= test unexpected conversion ==================\n");
	r = ft_printf("ft %a %%%% %i %#f %u\n", 0, 7.80, INT_MIN, INT_MIN);
	r1 = printf("pt %u\n", INT_MIN);
	return (0);
}